...
from .utils import load_hf_dataset, preprocess_chat_instance
...
class QAwithIdkDataset(QADataset):
    def __init__(self, idk_path: str, return_original: bool = True, *args, **kwargs):
...
class QAwithAlternateDataset(QADataset):
    def __init__(self, alternate_key: str, return_original: bool = True, *args, **kwargs):
