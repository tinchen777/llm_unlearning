...
made = []
for name, fn in [
    ("training_curves.png", lambda: plotter.plot_training_curves(RUN_DIRS)),
    ("metric_trajectories.png", lambda: plotter.plot_metric_trajectories(RUN_DIRS)),
    ("method_comparison.png", lambda: plotter.plot_method_comparison(RUN_DIRS)),
    ("tradeoff.png", lambda: plotter.plot_tradeoff(RUN_DIRS)),
]:
    try:
        plotter.save_fig(fn(), os.path.join(OUT_DIR, name))
        made.append(name)
